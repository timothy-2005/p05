/**
 * This class represents a toy in the game. It extends the GraphicObject class and implements the MouseListener and Movable interfaces.
 */
public class Toy extends GraphicObject implements MouseListener, Movable{
    ...
    public boolean isOver(int x, int y){
        if (x > this.x - image.width / 2 && x < this.x + image.width / 2 && y > this.y - image.height / 2 && y < this.y + image.height / 2){ // Checks if the mouse is over the toy
            return true;
        }
        return false;
    }

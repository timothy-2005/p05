...
/**
 * This class represents a hoverball in the toy saga game. It extends the Toy class and adds a switch on/off and movement
 */
public class Hoverball extends Toy{
    ...
    public void move(){
        if (!toySaga.isNightMode()){
            ...
            move(0, Math.round(6 * PApplet.sin(toySaga.frameCount * 0.1f))); // Moves the hoverball up and down
        }
    }
}

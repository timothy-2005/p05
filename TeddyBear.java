...
/**
 * This class represents a teddy bear in the toy saga game. It extends the Toy class and adds a callout and rotation
 */
    ...
    public void move(){
        if (!toySaga.isNightMode()){
            ...
            if (rotationDirection){ // If the rotation direction is true
                ...
                rotation = getRotation() - PApplet.radians(3);} // Decreases the rotation of the teddy bear
        }
    }
}
